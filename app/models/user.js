...
UserSchema.statics.findByIdentifier = async function (identifier, cb) {
    var opts = {};
    ...
    if (cb) {
        ...
        else cb("Không tìm thấy use", null);
    }
...
UserSchema.statics.authenticate = async function (identifier, password, cb) {
